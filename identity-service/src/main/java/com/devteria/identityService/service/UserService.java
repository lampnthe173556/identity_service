...
public class UserService {
    ...
    //@PreAuthorize(value = "hasRole('ADMIN')")//tim tat ca nhung scope co authority nao co prefix la Role moi duoc accept
    ...
    public UserResponse getUserByToken() {
        ...
        return userMapper
                .toUserResponse(userRepository.findUserByUsername(authentication.getName())
                        .orElseThrow(() -> new AppException(ErrorCode.USER_NOT_EXISTED)));
    }
}
